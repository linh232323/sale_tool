...
class MY_Controller extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->my_layout->setDefaultJs(array('jquery-1.8.2.min', 'jquery.livequery.min', 'qho.src','dataTable.boostrap')); // asset/public/css
        $this->my_layout->setDefaultCss(array('style','dataTable.boostrap')); // asset/public/css
