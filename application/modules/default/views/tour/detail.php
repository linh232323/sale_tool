...
<div class="container-fluid">
    <h1><?php echo $tour->getData('name'); ?></h1>
        ...
        <div class="span8">
            <div class="tabbable"> <!-- Only required for left/right tabs -->
              <ul class="nav nav-tabs">
                <li class="active"><a href="#tab-program" data-toggle="tab"><?php echo $localization->getText('Program','tour'); ?></a></li>
                <li><a href="#tab-appendix" data-toggle="tab"><?php echo $localization->getText('Appendix','tour'); ?></a></li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane active" id="tab-program">
                   <?php echo $tour->getData('program');?>
                </div>
                <div class="tab-pane" id="tab-appendix">
                    <?php echo $tour->getData('appendix');?>
                </div>
              </div>
            </div>
        </div>
