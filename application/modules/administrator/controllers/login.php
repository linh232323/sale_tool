...
class Login extends Admin_Controller {
    ...
    function login() {
        ...
        if ($this->flexi_auth->ip_login_attempts_exceeded()) {
             ...
             */
            $this->app_data['captcha'] = $this->flexi_auth->recaptcha(FALSE);
             ...
             */
            # $this->app_data['captcha'] = $this->flexi_auth->math_captcha(FALSE);
        }

        // Get any status message that may have been set.
        $this->app_data['message'] = (!isset($this->app_data['message'])) ? $this->session->flashdata('message') : $this->app_data['message'];
        $this->my_layout->view('/login/login_view',$this->app_data);
        //$this->load->view('demo/login_view', $this->app_data);
    }
    ...
    function login_via_ajax() {
        if ($this->input->is_ajax_request()) {
            ...
            $this->load->view('demo/login_via_ajax_view', $this->app_data);
        }
    }
    ...
    function register_account() {
        ...
        // Get any status message that may have been set.
        $this->app_data['message'] = (!isset($this->app_data['message'])) ? $this->session->flashdata('message') : $this->app_data['message'];
        $this->load->view('demo/public_examples/register_view', $this->app_data);
    }
    ...
    function resend_activation_token() {
        ...
        // Get any status message that may have been set.
        $this->app_data['message'] = (!isset($this->app_data['message'])) ? $this->session->flashdata('message') : $this->app_data['message'];
        $this->load->view('demo/public_examples/resend_activation_token_view', $this->app_data);
    }
    ...
    function forgotten_password() {
        ...
        // Get any status message that may have been set.
        $this->app_data['message'] = (!isset($this->app_data['message'])) ? $this->session->flashdata('message') : $this->app_data['message'];
        $this->load->view('demo/public_examples/forgot_password_view', $this->app_data);
    }
    ...
    function manual_reset_forgotten_password($user_id = FALSE, $token = FALSE) {
        ...
        // Get any status message that may have been set.
        $this->app_data['message'] = (!isset($this->app_data['message'])) ? $this->session->flashdata('message') : $this->app_data['message'];
        $this->load->view('demo/public_examples/forgot_password_update_view', $this->app_data);
    }
